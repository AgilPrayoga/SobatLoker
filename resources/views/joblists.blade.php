...
<div class="pt-[10%] flex flex-wrap justify-center ">
    @foreach ($job as $job)
    <a class="m-[20px] no-underline text-[#333]   " href="/joblists/{{$job->id}}">
        <div class="bg-white p-4 sm:p-8 flex flex-row border-1 border-gray-500 w-[350px] sm:w-[400px] h-[250px] rounded-lg hover:bg-gray-300 ">
            <div class="h-[60px] w-[60px] mr-6">
